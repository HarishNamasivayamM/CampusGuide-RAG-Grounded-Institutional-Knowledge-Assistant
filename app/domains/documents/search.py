...
from app.common.local_search import is_local_backend, local_document_search
...
def search(
    ...
    """
    if is_local_backend():
        return local_document_search(query, top_k=top_k, document_scope=document_scope)
