...
from app.common.local_search import is_local_backend, local_tuition_filter_values, local_tuition_search
...
def load_filter_values() -> dict:
    ...
    """
    if is_local_backend():
        return local_tuition_filter_values()
...
def _filter_query(known: dict, top_k: int) -> list:
    ...
    """
    if is_local_backend():
        return local_tuition_search(known, top_k)
